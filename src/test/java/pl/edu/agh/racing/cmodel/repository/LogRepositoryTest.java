...
public class LogRepositoryTest {
    ...
    public void shouldSaveLog() {
        ...
        Log log1 = new Log(null, Operation.ADD, Instant.now(), simulation, user);
        Log log2 = new Log(null, Operation.UPDATE, Instant.now(), simulation, user);
        Log sameLog = new Log(null, Operation.UPDATE, Instant.now(), simulation, user);
